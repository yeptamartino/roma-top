...
@section('content')
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#historyTransaksi">Tampilkan History Transaksi</button></h3>
      </div>
        <div class="row">
                        ...
                        <td>
                          <ul>
                            @foreach($transaction->transaction_items as $transaction_item)
                              <li>{{ $transaction_item->name }} (@rupiah($transaction_item->selling_price))</li>
                            @endforeach
                          </ul>
                        </td>
                        <td>
